...
{
    return GetBoolArg("-testnet", false) ? 26715 : 22451;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop Coven server (and possibly override the detachdb config value).");
